...
class SignUpActivity : AppCompatActivity() {
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    AddParent("101", name_edit_text.text.toString(), surname_edit_text.text.toString(),
                        street_edit_text.text.toString(), city_edit_text.text.toString(), email_edit_text.text.toString(),
    ...
    fun AddParent(id:String, name:String, surname:String, street:String, city:String, email:String, phoneNumber:String ){
